...
Here we say that pupil is *nested* within class because an individual pupil only occurs in one class. We say that extroversion and sex are *first-level* predictors because they are different for every pupil. We say that teacher experience is a *second-level* predictor because it is the same for all pupils in the same second-level group (class).
