...
The above plots ignore the effect of field (random slopes and intercepts) but we can also take that into account when generating the posterior expected values. 
